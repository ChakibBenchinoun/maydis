    ...
    <AdminQueryProvider>
      <SidebarProvider className="admin-surface bg-background min-h-svh">
        ...
        <SidebarInset>
          ...
          {/*
            Content left edge lines up with the sidebar toggle’s right edge:
            header px-4 (1rem) − trigger -ml-1 (0.25rem) + trigger size-7 (1.75rem) = 2.5rem → pl-10.
            Top bar / sidebar keep their own padding; only the page body is constrained.
          */}
          <main className="flex-1 py-6 pr-4 pl-10 md:py-8 md:pr-8">
