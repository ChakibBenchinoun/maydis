    ...
    >
      {items.map((item, i) => (
        <motion.button
          ...
          className="group focus-visible:ring-primary relative aspect-[4/5] w-full overflow-hidden rounded-2xl text-left shadow-md ring-1 ring-black/5 transition-[box-shadow,transform] duration-300 hover:-translate-y-0.5 hover:shadow-xl focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:outline-none"
        >
          ...
          <div
            className="pointer-events-none absolute inset-x-0 top-0 h-12 bg-gradient-to-b from-black/15 to-transparent"
            aria-hidden
          />

          {/* Bottom scrim — name + price sit on the photo */}
          <div className="pointer-events-none absolute inset-x-0 bottom-0 bg-gradient-to-t from-black/80 via-black/45 to-transparent pt-14 pb-3 sm:pt-16 sm:pb-3.5">
